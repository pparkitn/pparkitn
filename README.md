...
Senior Director · AI Solutions & Platform Engineering — Toronto, Canada
...
- **EdgeGuard AI** — modular, event-driven security system combining local face recognition and multi-sensor correlation to publish automated voice announcements via MQTT. [code](https://github.com/pparkitn/EdgeGuardAI)
...
- **Counterfeit — Sentiment-Enhanced Summarization** — sentiment signals in attention. [paper](https://github.com/pparkitn/pparkitn/blob/main/proj6/Final_Project_Piotr_Parkitny.pdf) · [code](https://github.com/pparkitn/pparkitn/tree/main/proj6)
...
- [LDA vs PCA](https://github.com/pparkitn/kaggle/blob/main/lda-vs-pca.ipynb) · [Kaggle](https://www.kaggle.com/code/dsptlp/lda-vs-pca)
- [Stock Regression](https://github.com/pparkitn/kaggle/blob/main/us-stock-market-prediction-histdecision-trees.ipynb) · [Kaggle](https://www.kaggle.com/code/dsptlp/regression-with-timeline-data)
...
- **MIDS — UC Berkeley** · Statistical ML, Deep Learning, Systems at Scale
- **B.Sc. Eng Systems & Computing — University of Guelph** · Control Systems, Signal Processing, Software Engineering
